---
layout: post
title: "How I Built A Custom Protein-Binding Dataset for Machine Learning"
description: A walkthrough on building an ML-friendly dataset with code, data visualizations, and cited sources.
tags: project bioinformatics ml
image: /img/seo/pepbdb-ml-cover.png
thumb: /img/thumb/pepbdb-ml-cover.webp
expanded: /img/expanded/pepbdb-ml-expanded.png
---
...
- [Background: CNNs can predict binding sites](#background-cnns-can-predict-binding-sites)
- [The Rationale: But wait — does the data really matter that much?](#the-rationale-but-wait--does-the-data-really-matter-that-much)
  - [1. Availability](#1-availability)
  - [2. Quality](#2-quality)
  - [3. Interpretability](#3-interpretability)
- [The Process: Building the PepBDB-ML dataset](#the-process-building-the-pepbdb-ml-dataset)
- [1. Initial filtering](#1-initial-filtering)
- [2. Sequence extraction using BioPython](#2-sequence-extraction-using-biopython)
- [3. Binding sequences determination with PRODIGY](#3-binding-sequences-determination-with-prodigy)
- [4. Adding sequence level information with AAindex and PSI-BLAST](#4-adding-sequence-level-information-with-aaindex-and-psi-blast)
  - [AAindex](#aaindex)
  - [PSI-BLAST](#psi-blast)
- [5. Structural information using BioPython](#5-structural-information-using-biopython)
  - [Secondary structure codes, half-sphere exposure, and from DSSP](#secondary-structure-codes-half-sphere-exposure-and-from-dssp)
- [Optional: Generating an image dataset](#optional-generating-an-image-dataset)
- [The Results: Visualizing the PepBDB-ML database](#the-results-visualizing-the-pepbdb-ml-database)
  - [Amino acid distributions](#amino-acid-distributions)
  - [Correlation mapping](#correlation-mapping)
  - [Feature distributions](#feature-distributions)
  - [Statistical tests](#statistical-tests)
- [The Discussion: Key takeaways and learnings](#the-discussion-key-takeaways-and-learnings)
...
So that is precisely what I set out to do with [**PepBDB-ML**](https://github.com/MurtoHilali/PepBDB-ML)
